		...
		<div class="container-fluid text-center ">
			<ul class="nav flex-column">
				...
				<li class="nav-item dropdown"><a
					...
					role="button" aria-expanded="false"><i class="fa-brands fa-java fa-lg"></i>Java</a>
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#"
					role="button" aria-expanded="false"><i class="fa-brands fa-js fa-lg"></i>Javascript</a>
					<ul class="dropdown-menu">
				...
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#"
					role="button" aria-expanded="false"><i class="fa-solid fa-database fa-lg"></i>Database</a>
					<ul class="dropdown-menu">
